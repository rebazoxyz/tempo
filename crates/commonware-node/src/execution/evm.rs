...
// TODO: Currently a NOOP; replace it with the actual precompiles.
fn extend_tempo_precompiles<DB: Database, I: Inspector<EthEvmContext<DB>>>(
    _evm: &mut EthEvm<DB, I, PrecompilesMap>,
) {
}
