...
description: "This specification introduces a second consensus gas constraint for non-payment transactions. Transactions are classified as either payments or non-payments"
---
