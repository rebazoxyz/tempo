...
description: "This proposal allows non-proposing validators to propose a limited set of transactions in each block through signed sub-blocks. Sub-blocks are sent directly to"
---
