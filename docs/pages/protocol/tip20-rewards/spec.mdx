---
title: "TIP-20 Rewards Distribution"
description: "An opt-in, scalable, pro-rata reward distribution mechanism built into TIP-20 tokens. The system uses a \"reward-per-token\" accumulator pattern to distribute"
---
