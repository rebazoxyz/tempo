---
title: "Accounts"
description: "Note: This feature will likely be deprecated before mainnet launch. We recommend using the standard Tempo Transaction type instead if you need smart contract..."
---
