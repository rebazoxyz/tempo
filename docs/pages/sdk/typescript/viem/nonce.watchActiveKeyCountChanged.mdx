---
title: "Nonce.watchActiveKeyCountChanged"
description: "Watches for active key count changed events. This event is emitted when an account starts using a new nonce key for the first time."
---
