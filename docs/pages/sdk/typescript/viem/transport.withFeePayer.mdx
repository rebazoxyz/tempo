---
title: "WithFeePayer"
description: "Creates a transport that routes transactions to a fee payer service when a feePayer is requested on an action. Learn more about Fee Sponsorship"
---
