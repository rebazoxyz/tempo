---
title: "Nonce.useWatchActiveKeyCountChanged"
description: "Hook for watching active key count changed events. This event is emitted when an account starts using a new nonce key for the first time."
---
