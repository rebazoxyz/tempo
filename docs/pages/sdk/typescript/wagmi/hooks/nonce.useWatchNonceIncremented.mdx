---
title: "Nonce.useWatchNonceIncremented"
description: "Hook for watching nonce incremented events. This event is emitted whenever a transaction is executed using a specific nonce key."
---
