---
title: "Nonce.watchNonceIncremented"
description: "Watches for nonce incremented events. This event is emitted whenever a transaction is executed using a specific nonce key."
---
