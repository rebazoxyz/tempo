...
description: "Creates a server handler that acts as a fee payer for transactions. This enables you to subsidize gas costs for your users by signing transactions with a ded..."
---
