---
title: "Handler.keyManager"
description: "Creates a server handler that manages WebAuthn credential public keys. This handler stores and retrieves the public keys associated with passkey credentials,..."
---
