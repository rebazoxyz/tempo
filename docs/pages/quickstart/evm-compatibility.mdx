...
description: "Tempo is fully compatible with the Ethereum Virtual Machine (EVM), targeting the Osaka EVM hard fork. Developers can deploy and interact with smart contracts..."
---
