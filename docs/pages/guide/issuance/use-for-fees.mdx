...
Before users can pay fees with your token, ensure there is sufficient liquidity in the fee pool. On the Moderato testnet, all validators expect fees in DONOTUSE, so you need to add DONOTUSE liquidity to your token's fee pool.
...
const validatorToken = '0x20c000000000000000000000033abb6ac7d235e5' // DONOTUSE on testnet
...
const { data: pool } = Hooks.amm.usePool({
  userToken: yourToken,
  validatorToken: '0x20c0000000000000000000000000000000000001', // DONOTUSE on testnet
})
