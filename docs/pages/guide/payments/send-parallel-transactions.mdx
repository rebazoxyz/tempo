...
description: "Submit multiple transactions in parallel using Tempo's 2D nonces. The nonceKey property allow you to send concurrent transactions without waiting for each one"
---
