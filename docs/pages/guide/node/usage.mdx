...
description: "RPC nodes provide API access to the Tempo network without participating in consensus. These nodes currently observe and sync with the network's latest state."
---
